...
namespace AutofacSamples
{
    ...
    public class ConsoleLog : ILog, IConsole {
        public ConsoleLog() {
            Console.WriteLine("ctor ConsoleLog");
            // für Breakpoint
        }
        public void Write(string message) {
    ...
    internal class Program {
        ...
        public static void DemoInstanceScope() {
            ...
            using (var scope3 = container.BeginLifetimeScope("foo")) {
                scope3.Resolve<ConsoleLog>();
            }

            using (var scope4 = container.BeginLifetimeScope()) {
                scope4.Resolve<ConsoleLog>();
            }
        }
        ...
        public static void DemoNoSingleton() {
            ...
            ConsoleLog? lastConsoleLog = null;
            for (int i = 0; i < 3; i++) {
                var newConsoleLog = container.Resolve<ConsoleLog>();
                var eq = lastConsoleLog == newConsoleLog;
